package com.daviaugusto.projetospring.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> resorcenotfound(DatabaseException e, HttpServletRequest request){
