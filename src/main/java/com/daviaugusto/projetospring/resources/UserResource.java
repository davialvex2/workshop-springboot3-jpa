...
import com.daviaugusto.projetospring.services.UserService;
...
public class UserResource {
	...
	public ResponseEntity<List<User>> buscarTodos(){
		List<User> obj = service.buscarTodos();
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<User> updade(@PathVariable Long id, @RequestBody User user){
